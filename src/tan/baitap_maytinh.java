 ...
 * @author SPC
 */
public class baitap_maytinh extends javax.swing.JFrame {

    /**
     * Creates new form baitap_maytinh
     */
    public baitap_maytinh() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(baitap_maytinh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new baitap_maytinh().setVisible(true);
            }
        });
    }
